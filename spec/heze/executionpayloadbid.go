...
// ExecutionPayloadBid represents an execution payload bid for EIP-7732, carrying
// the inclusion list bits added in Heze (EIP-7805).
type ExecutionPayloadBid struct {
	...
	BuilderIndex          gloas.BuilderIndex         `ssz-index:"6"`
