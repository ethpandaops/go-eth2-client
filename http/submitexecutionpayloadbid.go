...
func (s *Service) SubmitExecutionPayloadBid(ctx context.Context,
	...
	case spec.DataVersionHeze:
		if versioned.Heze == nil {
			return errors.Join(errors.New("no heze bid supplied"), client.ErrInvalidOptions)
		}
...
func (s *Service) SubmitAgnosticExecutionPayloadBid(ctx context.Context,
	...
	return s.postExecutionPayloadBid(ctx, &opts.Common,
		opts.SignedExecutionPayloadBid.Version, opts.SignedExecutionPayloadBid)
}
